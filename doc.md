...
Để dự án này không bị "vỡ trận" lúc đang code, bạn phải kiểm soát gắt gao team Kỹ thuật ở Phase 3 với 2 bài toán sống còn:
...
Có giao diện Tòa án trung tâm (Arbitration) cho Admin: Admin xem bằng chứng 2 bên và bấm phán quyết: Hoàn tiền cho Buyer hoặc Bác bỏ khiếu nại, chuyển tiền cho Seller.
