...
\usepackage{newtxtext, newtxmath} % Font Times New Roman tốt hơn cho tiếng Việt
\usepackage[T5]{fontenc} % Bắt buộc T5 cho tiếng Việt thay vì T1
\usepackage[utf8]{inputenc}
\usepackage[vietnamese]{babel}
\usepackage{microtype} % Tự động căn chỉnh khoảng cách chữ để tránh tràn lề
\emergencystretch 3em % Cho phép giãn cách linh hoạt hơn khi gặp từ dài
...
% Ngăn chặn tràn lề cho các từ chuyên môn dài
\hyphenation{Wallet-Trans-action escrow-Balance Sub-Order Master-Order Next-js}
