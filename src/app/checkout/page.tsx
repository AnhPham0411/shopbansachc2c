      ...
      <div className="container mx-auto px-6 md:px-12 pt-44 max-w-6xl">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500 font-bold uppercase tracking-widest mt-0.5">{t("checkout.subtitle")}</p>
          </div>
        </div>
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-black text-lg">{t("checkout.address")}</h3>
              </div>
          ...
          {isAddressModalOpen && (
               ...
               >
                 <div className="p-8">
                   <div className="flex items-center justify-between mb-8">
                      <h3 className="text-2xl font-black">{t("checkout.newAddress")}</h3>
                      <button 
                        onClick={() => setIsAddressModalOpen(false)}
                   ...
                   <form onSubmit={handleSaveAddress} className="space-y-6">
                     <div className="space-y-2">
                       <label className="text-xs font-black text-zinc-400 uppercase tracking-widest ml-1">{t("checkout.fullName")}</label>
                       <input 
                         type="text" 
                         required
                     ...
                     <div className="space-y-2">
                       <label className="text-xs font-black text-zinc-400 uppercase tracking-widest ml-1">{t("checkout.phone")}</label>
                       <input 
                         type="tel" 
                         required
                     ...
                     <div className="space-y-2">
                       <label className="text-xs font-black text-zinc-400 uppercase tracking-widest ml-1">{t("checkout.addressDetail")}</label>
                       <textarea 
                         required
                         rows={3}
              ...
              >
                <div className="px-8 py-4 bg-zinc-50 border-b border-zinc-100 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-black text-zinc-700">{t("checkout.packageFrom").replace("{name}", groupedItems[sellerId].sellerName)}</span>
                  </div>
                ...
                <div className="p-8 space-y-6">
                    ...
                    <div key={item.id} className="flex gap-6">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                           <span className="text-xs font-bold text-zinc-400">{t("checkout.quantity").replace("{count}", String(item.quantity))}</span>
                  ...
                  <div className="pt-6 border-t border-zinc-50 flex flex-col sm:flex-row justify-between items-center bg-zinc-50/50 -mx-8 -mb-8 px-8 py-4">
                    <div className="flex items-center gap-4 text-sm font-medium text-zinc-500 mb-4 sm:mb-0">
                      ...
                      <span className="bg-primary/10 text-primary px-3 py-1 rounded-full font-black text-xs">{t("checkout.freeShipping")}</span>
                    </div>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-black text-lg">{t("checkout.voucher")}</h3>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <span className="text-xs font-bold uppercase tracking-widest pl-2">{t("checkout.selectOtherVoucher")}</span>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">{t("checkout.codeApplied")}: {appliedVoucher.code}</p>
                      </div>
                    </div>
                    <button 
          ...
          <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-32">
            ...
            <div className="bg-white p-8 rounded-[32px] border border-zinc-200 shadow-sm space-y-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-black text-lg">{t("checkout.payment")}</h3>
              </div>
              ...
              <div className="space-y-3">
                ...
                >
                   ...
                   <div className="flex-1">
                       <p className="text-sm font-black">{t("checkout.cod")}</p>
                      <p className="text-[10px] font-bold text-zinc-400 uppercase">{t("checkout.codDesc")}</p>
                   </div>
                ...
                >
                   ...
                   <div className="flex-1">
                       <p className="text-sm font-black">{t("checkout.vnpay")}</p>
                      <p className="text-[10px] font-bold text-zinc-400 uppercase">{t("checkout.vnpayDesc")}</p>
                   </div>
                ...
                >
                   ...
                   <div className="flex-1">
                       <p className="text-sm font-black">{t("checkout.momo")}</p>
                      <p className="text-[10px] font-bold text-zinc-400 uppercase">{t("checkout.momoDesc")}</p>
                   </div>
            ...
            <div className="bg-white p-8 rounded-[40px] border border-zinc-200 shadow-sm space-y-8">
               <h2 className="text-xl font-black text-zinc-900 border-b border-zinc-50 pb-4">{t("checkout.paymentDetail")}</h2>
               ...
               <div className="flex justify-between items-end">
                 <span className="font-black text-zinc-900 uppercase tracking-wider text-xs">{t("checkout.total")}</span>
               ...
               >
                 <div className="p-8 bg-white border-b border-zinc-100 flex-shrink-0">
                   <div className="flex items-center justify-between">
                      <div>
                        <h3 className="text-2xl font-black">{t("checkout.voucher")}</h3>
                        <p className="text-xs text-zinc-400 font-bold uppercase tracking-widest mt-1">{t("checkout.selectVoucher")}</p>
                      </div>
                      <button 
                        onClick={() => setIsVoucherModalOpen(false)}
                        className="p-2 hover:bg-zinc-100 rounded-full transition-all"
                 ...
                 <div className="flex-1 overflow-y-auto p-8 space-y-4">
                    {availableVouchers.length === 0 ? (
                      <div className="text-center py-10">
                        ...
                        <p className="text-zinc-500 font-bold">{t("checkout.noVouchers")}</p>
                      </div>
                    ) : (
